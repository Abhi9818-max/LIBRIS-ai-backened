...
import { FileText } from "lucide-react"; // For PDF button icon
...
export default function BookDetailView({ book, isOpen, onClose }: BookDetailViewProps) {
  ...
  const handleOpenPdfInDetailView = () => {
    ...
    // Logic copied and adapted from BookCard.tsx
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl md:max-w-3xl lg:max-w-4xl max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-grow overflow-y-auto grid grid-cols-1 md:grid-cols-3 gap-6 p-6 pt-2">
          <div className="md:col-span-1 flex flex-col items-center space-y-4">
            <div className="relative w-[250px] h-[375px] sm:w-[300px] sm:h-[450px]">
                <Image
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            {book.totalPages && book.totalPages > 0 && (
              <div>
                <h3 className="text-xl font-semibold font-headline mb-1">Reading Progress</h3>
